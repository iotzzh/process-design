<template>
    <div className="pattern">
      <div className="pattern-selection"  @mousedown.native="() => openSelection()" />
      <div>选区</div>
      <div className="pattern-start"  @mousedown.native="() => addStartNode()" />
      <div>开始</div>
      <div className="pattern-user"  @mousedown.native="() => addUserTask()"></div>
      <div>用户任务</div>
      <div className="pattern-user"  @mousedown.native="() => addServiceTask()"></div>
      <div>系统任务</div>
      <div className="pattern-condition"  @mousedown.native="() => addGateWay()"></div>
      <div>条件判断</div>
      <div className="pattern-end"  @mousedown.native="() => addEndNode()"></div>
      <div>结束</div>
    </div>
</template>
...
function addStartNode() {
  ...
  lf.value && lf.value.on('selection:selected', () => {
    lf.value.updateEditConfig({
      stopMoveGraph: false,
    });
  });
